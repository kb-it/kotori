    ...
    <div class="tile is-ancestor">
        <div class="tile is-12 is-vertical is-parent">
            <div class="tile is-child box">
                ...
                <div class="content">
                    <h2 class="title is-2 has-text-dark">Legal Disclosure</h2>
                    <h3>Information in accordance with section 5 TMG</h3>
                    <address>
                        Steffen Butzer & Kevin Bittner<br>
                        Rotebühlplatz 41/1<br>
                        70178 Stuttgart<br>
                        E-Mail: it16177@lehre.dhbw-stuttgart.de
                    </address>

                    <h3>Indication of source for images and graphics</h3>
                    <ul class="list-unstyled">
                        <li>
                            <a class="has-text-link" href="https://pixabay.com/de/kardinal-vogel-cardinalidae-tier-150253" target="_blank">Logo</a>
                        </li>
                    </ul>
